...
import { getSelectValueById, getInputElementValueById, getUnitConversion } from "@utils/helpers";
...
const cal = () => {
    ...
    const fromConvertion = getUnitConversion(unitData, unitType, selectFromValue);
